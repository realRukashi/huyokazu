...
st.markdown('<p class="big-font">Xin chào, mình là Thanh Huy, cực học sinh trường THPT chuyên Nguyễn Bỉnh Khiêm, Quảng Nam và hiện tại mình là sinh viên lớp CNTN khoa CNTT của HCMUS.</p>', unsafe_allow_html=True)
